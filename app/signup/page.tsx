export default function SignUp() {
  return (
    <main className="min-h-screen flex-col items-center justify-center bg-black text-white p-8">
      ...
      <form action="/auth/signup" method="post" className="space-y-4 w-full max-w-sm">
        ...
        <button type="submit" className="w-full p-3 bg-purple-600 rounded">Create Account</button>
      </form>
    </main>
  )
}
